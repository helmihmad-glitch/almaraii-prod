...
type ProtectedAction = { kind: "edit" | "delete"; row: any };
...
export default function Home() {
  ...
  const confirmProtectedAction = async () => {
    ...
    setActionPassword("");
    if (kind === "edit") { setEditActionPassword(verification.authorized ? actionPassword : ""); openEditEntry(row); return; }
    if (row.id) deleteEntry.mutate({ id: row.id, actionPassword });
