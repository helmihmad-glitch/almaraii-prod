...
export default function Home() {
  ...
  const filteredDays = useMemo(() => registryDays.filter((day) => (articleFilter === "Toutes les lignes" || day.article === articleFilter) && (!query || day.article.toLowerCase().includes(query.toLowerCase()) || day.date.includes(query))), [month, articleFilter, query]);
