  ...
  return (
    <main className="daily-program-screen">
      ...
      <section className="daily-program-page">
        <div className="daily-program-hero daily-program-data-hero"><div><span className="daily-program-kicker"><Database size={14} />Administration</span><h1>Programme journalier <em>donnée</em></h1><p>Créez les programmes quotidiens, attribuez les pupitreurs et planifiez les articles configurés.</p></div><label className="daily-program-date"><span>Date à gérer</span><div><CalendarDays size={16} /><input type="date" value={selectedDate} onChange={(event) => setSelectedDate(event.target.value)} aria-label="Choisir la date à gérer" /></div></label></div>
